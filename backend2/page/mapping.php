...
if(isset($_POST['modif'])){
	...
	updTable("mapping",$champ,$valeur,"id",$_POST['modif']);
	echo "<script language='Javascript'>
		<!--
...
<tbody>
<?php
$liste=selTableDataDesc("mapping","id");
...
$modification=selTableDataWhere("mapping","id",$_GET['modif']);
?>
