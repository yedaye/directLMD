...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	if($_POST['letype']=='reinscription'){
		...
		//////  Enregistrement du nouvel étudiant
		$matricule=$_POST['matricule'];
		$qstr1 = "UPDATE student SET situ_fam='".$_POST['situation_familiale']."',nombre_enfant='".$_POST['nombre_enfant']."',email='".$_POST['email']."',telephone='".$_POST['telephone']."',adresse_postal='".$_POST['bp']."' WHERE matricule='".$matricule."'" ;
