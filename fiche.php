...
if(isset($_GET['matricule']) || isset($_GET['num_table'])){
	...
	$ecu=selTableData2Fields("reprise_ecu","matricule",$etudiant['matricule'],"annee_academique",$_GET['an_etude'],$pdo);
	if(count($inscription)>0){
		...
		<!-- fwtable fwsrc="fiche_ecu.png" fwpage="Page 1" fwbase="fiche_ecu.jpg" fwstyle="Dreamweaver" fwdocid = "1350424229" fwnested="0" -->
		  ...
		  <tr>
		   <td colspan="7" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r16_c4.jpg"><?php 	
					$ecole=selTableDataWhere("filiere","code",$inscription[0]['filiere'],$pdo);
		   ...
		   <table bordercolor="#CCCCCC" width="99%" border="1" cellspacing="0">
			 ...
			 <tr >
			   <td><?php 
				...
				//print_r($lib);
				echo utf8_decode($lib['designation'])." (".$ecu[$i]['code_ecu'].")";
				?></td>
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
           ...
           <td colspan="15" align="center" valign="middle" background="images/fiche_r6_c5.jpg"><?php echo $inscription[0]['matricule']; ?></td>
          ...
          <tr>
           ...
           <td colspan="3" rowspan="2" align="center" valign="middle" background="images/fiche_r23_c17.jpg"><?php echo $inscription[0]['FF']+ $inscription[0]['FI']; ?></td>
          ...
          <tr>
           ...
           <td colspan="15" align="center" valign="middle" background="images/fiche_r30_c4.jpg"><?php echo $inscription[0]['matricule']; ?></td>
          ...
          <tr>
           ...
           <td colspan="3" align="center" valign="middle" background="images/fiche_r47_c16.jpg"><?php echo $inscription[0]['FF']+ $inscription[0]['FI']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="26" border="0" alt="" /></td>
          </tr>
          <tr>
