...
if(isset($_POST['code'])){
	...
	$controle=selTableDataCount2("table_ue_new","code_ue",$_POST['code'],"promotion",$_POST['promo'],$pdo);
	if($controle==0){
		...
		insTable("table_ue_new",$champ,$valeur,$pdo);
...
if(isset($_POST['modif'])){
	...
	updTableWhereArray("table_ue_new",$champ,$valeur,$ArWherField,$ArWherVal,$pdo);
...
if(isset($_POST['lot'])){
    // print_r($_POST['lot']);
     ...
     while(($data=fgetcsv($handle,1000,";"))!==FALSE){
        ...
        $champ=array('code_ue','designation','credit','code_ecole','promotion','semestre');
        $valeur=array($code_ue,$designation,$credit,$code_ecole,$promotion,$semestre);
        insTable("table_ue_new",$champ,$valeur,$pdo);
     }
     echo "<script language='Javascript'>
     <!--
...
<div id="toolbar" align="right">  
    <a href="?ue_new&ajoutlot" class="easyui-linkbutton" iconCls="icon-add" plain="true">Importer un fichier csv</a> 
...
<tbody>
<?php
$liste=selTableData("table_ue_new","code_ue",$pdo);
...
if(isset($_GET['modif']) && $_GET['modif']!="" && !isset($_GET['ajout'])){ 
$modification=selTableData2Fields("table_ue_new","code_ue",$_GET['modif'],'promotion',$_GET['promo'],$pdo);
?>
<div align="center" id='retour' style="display:none"> <a href="ue_new.php" class="easyui-linkbutton">RETOUR</a></div>
