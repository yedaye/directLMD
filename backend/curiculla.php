	  ...
	  <table width="80%" border="0" align="center" cellspacing="2">
	    <tr>
	      ...
	      <td width="36%" align="left"><select required="true" name="promotion" id="promotion">
                    <option value='P1' <?php if(isset($_GET['promotion']) && $_GET['promotion']=='P1'){ echo "selected=\"selected\""; } ?>>Promo1 </option>
					<option value='P2' <?php if(isset($_GET['promotion']) && $_GET['promotion']=='P2'){ echo "selected=\"selected\""; } ?>>Promo2</option>					
					<option value='P3' <?php if(isset($_GET['promotion']) && $_GET['promotion']=='P3'){ echo "selected=\"selected\""; } ?>>Promo3</option>
					<option value='P4' <?php if(isset($_GET['promotion']) && $_GET['promotion']=='P4'){ echo "selected=\"selected\""; } ?>>Promo4</option>
...
<div align='center'><a href="Excel/sortieFichier2.php" target="_blank"><img src="../img/excel.jpg" alt="" align="left" border="0" height="33" width="32"></a><br>
 ...
 <?php
	$ue=array();
	$ue=selTableData2FieldsAsc("table_ue_new","code_ecole",$_GET['filieres'],"promotion",$_GET['promotion'],"designation",$pdo);
	//print_r($ue);
	$a=0;
	...
	?>
  <tr bgcolor="#D0DBF9">
    <td bgcolor="#D0DBF9"><b><?php echo strtoupper($ue[$i]['designation']."(".$ue[$i]['code_ue'].")"); ?></b></td>
    <td align="center" bgcolor="#D0DBF9"><b><?php echo $ue[$i]['credit']; ?></b></td>
  </tr>
	<?php 
			$ecu=selTableData2FieldsAsc("table_ecu_new","code_ue",$ue[$i]['code_ue'],"promotion",$_GET['promotion'],"designation",$pdo);
			...
			?>
			<tr bgcolor="#FFFFCC">
			<td bgcolor="#FFFFCC"><?php echo utf8_decode(strtoupper($ecu[$a]['designation']))."  (".$ecu[$a]['code_ecu'].")"; ?></td>
