...
if(isset($_GET['matricule']) || isset($_GET['num_table'])){
	...
	$inscription=selTableData2Fields("inscription","matricule",$etudiant['matricule'],"annee_academique",$_GET['annee'],$pdo);
	//print_r($inscription);
	...
	if(count($inscription)>0){
		...
		<!-- fwtable fwsrc="fiche_ecu.png" fwpage="Page 1" fwbase="fiche_ecu.jpg" fwstyle="Dreamweaver" fwdocid = "1350424229" fwnested="0" -->
		  ...
		  <tr>
		   ...
		   <td colspan="4" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r2_c7.jpg"><?php echo $_GET['annee']; ?></td>
		  ...
		  <tr>
		   <td colspan="4" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r4_c7.jpg"><?php echo $inscription['num_inscription']; ?></td>
		   <td><img src="../fiche/image_ecu/spacer.gif" width="1" height="36" border="0" alt="" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		   ...
		   <td colspan="7" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r6_c4.jpg"><?php echo $inscription['matricule']." (".$etudiant['email_uak'].")"; ?></td>
		  ...
		  <tr>
		   <td colspan="7" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r8_c4.jpg"><?php echo $etudiant['nom']; ?></td>
		   <td><img src="../fiche/image_ecu/spacer.gif" width="1" height="27" border="0" alt="" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		   <td colspan="7" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r10_c4.jpg"><?php echo $etudiant['prenoms']; ?></td>
		   <td><img src="../fiche/image_ecu/spacer.gif" width="1" height="27" border="0" alt="" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		   <td colspan="7" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r12_c4.jpg"><?php echo $etudiant['date_naissance']; ?> / <?php echo $etudiant['lieu_naissance']; ?></td>
		   <td><img src="../fiche/image_ecu/spacer.gif" width="1" height="27" border="0" alt="" /></td>
		  </tr>
		  <tr>
		  ...
		  <tr>
		   ...
		   <td colspan="5" rowspan="2" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r18_c3.jpg"><?php echo $inscription['filiere']; ?></td>
		  ...
		  <tr>
		   ...
		   <td rowspan="2" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r19_c10.jpg"><?php echo $inscription['statut']; ?></td>
		  ...
		  <tr class="totat">
		   <td colspan="2" rowspan="2" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r22_c3.jpg"><?php echo $inscription['FI']; ?></td>
		  ...
		  <tr class="totat">
		   ...
		   <td colspan="3" rowspan="2" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r23_c6.jpg"><?php echo $inscription['FF']; ?></td>
		   ...
		   <td rowspan="2" align="center" valign="middle" background="../fiche/image_ecu/fiche_ecu_r23_c10.jpg"><?php echo $inscription['FF']+ $inscription['FI']; ?></td>
       ...
       if(isset($ecu[0])){
			 ...
			 <tr >
			   <td><?php 
//				if(substr($ecu[$i]['code_ecu'],0,3)=='ECU'){
				//	$lib=selTableDataWhere("table_ecu","code_ecu",$ecu[$i]['code_ecu'],$pdo);
			//	}else{
					//echo "////".$ecu[$i]['code_ecu']."///";
					$lib=selTableDataWhere("table_ecu_new","code_ecu",$ecu[$i]['code_ecu'],$pdo);
			//	}
			//	print_r($lib);
				echo $lib['designation']." (".$ecu[$i]['code_ecu'].")";
				?></td>
        ...
        ?>
			 <tr >
			   <td><?php 
				if(substr($ecu[$i]['code_ecu'],0,3)=='ECU'){
					$lib=selTableDataWhere("table_ecu","code_ecu",$ecu['code_ecu'],$pdo);
				}else{
					//echo "////".$ecu[$i]['code_ecu']."///";
					$lib=selTableDataWhere("table_ecu_new","code_ecu",$ecu['code_ecu'],$pdo);
				}
			//	print_r($lib);
				echo $lib['designation']." (".$ecu['code_ecu'].")";
				?></td>
			   <td><?php echo $lib['credit']; ?></td>
			   <td><?php 
			   $tot=$tot+round(7000*$lib['credit']);
		   ...
		   <table bordercolor="#CCCCCC" width="99%" border="1" cellspacing="0">
			 <tr class="totat">
				...
				<td colspan="2" align="center"> <?php echo $tot+$inscription['FF']+ $inscription['FI']; ?> FCFA</td>
			 </tr>
			 </table>
		   </td>
        ...
        <table width="650" border="0" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
           ...
           <td colspan="9" align="center" valign="middle" background="images/fiche_r2_c11.jpg"><?php echo $_GET['annee']; ?></td>
          ...
          <tr>
           <td colspan="9" align="center" valign="middle" background="images/fiche_r4_c11.jpg"><?php echo $inscription['num_inscription']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="36" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           ...
           <td colspan="15" align="center" valign="middle" background="images/fiche_r6_c5.jpg"><?php echo $inscription['matricule']." (".$etudiant['email_uak'].")"; ?></td>
          ...
          <tr>
           <td colspan="15" align="center" valign="middle" background="images/fiche_r8_c5.jpg"><?php echo $etudiant['nom']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="27" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           <td colspan="15" align="center" valign="middle" background="images/fiche_r10_c5.jpg"><?php echo $etudiant['prenoms']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="27" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           <td colspan="15" align="center" valign="middle" background="images/fiche_r12_c5.jpg"><?php echo $etudiant['date_naissance']; ?> / <?php echo $etudiant['lieu_naissance']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="27" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           ...
           <td colspan="10" rowspan="2" align="center" valign="middle" background="images/fiche_r18_c3.jpg"><?php echo $inscription['filiere']; ?></td>
          ...
          <tr>
           ...
           <td colspan="3" rowspan="2" align="center" valign="middle" background="images/fiche_r19_c17.jpg"><?php echo $inscription['statut']; ?></td>
          ...
          <tr>
           <td colspan="4" rowspan="2" align="center" valign="middle" background="images/fiche_r22_c3.jpg"><?php echo $inscription['FI']; ?></td>
          ...
          <tr>
           ...
           <td colspan="6" rowspan="2" align="center" valign="middle" background="images/fiche_r23_c9.jpg"><?php echo $inscription['FF']; ?></td>
           ...
           <td colspan="3" rowspan="2" align="center" valign="middle" background="images/fiche_r23_c17.jpg"><?php echo $inscription['FF']+ $inscription['FI']; ?></td>
          ...
          <tr>
           ...
           <td colspan="8" align="center" valign="middle" background="images/fiche_r26_c10.jpg"><?php echo $_GET['annee']; ?></td>
          ...
          <tr>
           <td colspan="8" align="center" valign="middle" background="images/fiche_r28_c10.jpg"><?php echo $inscription['num_inscription']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="36" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           ...
           <td colspan="15" align="center" valign="middle" background="images/fiche_r30_c4.jpg"><?php echo $inscription['matricule']." (".$etudiant['email_uak'].")"; ?></td>
          ...
          <tr>
           <td colspan="15" align="center" valign="middle" background="images/fiche_r32_c4.jpg"><?php echo $etudiant['nom']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="27" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           <td colspan="15" align="center" valign="middle" background="images/fiche_r34_c4.jpg"><?php echo $etudiant['prenoms']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="27" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           <td colspan="15" align="center" valign="middle" background="images/fiche_r36_c4.jpg"><?php echo $etudiant['date_naissance']; ?> / <?php echo $etudiant['lieu_naissance']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="27" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           ...
           <td colspan="10" rowspan="2" align="center" valign="middle" background="images/fiche_r42_c2.jpg"><?php echo $inscription['filiere']; ?></td>
          ...
          <tr>
           ...
           <td colspan="3" rowspan="2" align="center" valign="middle" background="images/fiche_r43_c16.jpg"><?php echo $inscription['statut']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="26" border="0" alt="" /></td>
          </tr>
          <tr>
          ...
          <tr>
           <td colspan="4" rowspan="2" align="center" valign="middle" background="images/fiche_r46_c2.jpg"><?php echo $inscription['FI']; ?></td>
          ...
          <tr>
           ...
           <td colspan="6" align="center" valign="middle" images/fiche_r47_c8.jpg><?php echo $inscription['FF']; ?></td>
           ...
           <td colspan="3" align="center" valign="middle" background="images/fiche_r47_c16.jpg"><?php echo $inscription['FF']+ $inscription['FI']; ?></td>
           <td><img src="images/spacer.gif" width="1" height="26" border="0" alt="" /></td>
          </tr>
          <tr>
...
if(isset($_POST['matricule'])){
	$inscription=selTableData2Fields("inscription","matricule",$_POST['matricule'],"annee_academique",$_POST['annee'],$pdo);
	//print_r($inscription);
	if(count($inscription)>0){
		if($_POST['matricule']!=""){
			echo "<p align='center'><a href='fiche.php?num_table=&matricule=".$_POST['matricule']."&annee=".$_POST['annee']."' target='_blank'><img src='../img/fiche.png'><br/>Imprimez votre fiche de préinscription</a><br/>";
		}else{
			echo "<p align='center'><a href='fiche.php?matricule=&num_table=".$_POST['num_table']."&annee=".$_POST['annee']."'  target='_blank'><img src='../img/fiche.png'><br>Imprimez votre fiche de préinscription</a><br/>";	
		}		
	}else{
