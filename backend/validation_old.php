...
if(isset($_POST['nom'])){
	$array_field=array('nom','prenoms','date_naissance','lieu_naissance');
	$array_value=array(utf8_decode($_POST['nom']),utf8_decode($_POST['prenoms']),$_POST['date_nais'],utf8_decode($_POST['lieu_naissance']));
...
if($_FILES['photo_new']['name']!=""){
	...
	print_r($_FILES);
	break;
	copy($_FILES['photo_new']['tmp_name'],"photo/".$_POST['matricule2'].".jpg");
}
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="2" class="datagrid-body" style='font-size:18px'>
    ...
    <tr>
      <td colspan="2" align="center" valign="middle"><?php
		...
		?>
        	<img src="<?php echo "photo/2013/".trim($etudiant['num_table'])."_2013.jpg"; ?>" alt="" name="photo" width="220" height="187" id="photo" />
        <?php	
		}
	  ?>
	</td>
      <td colspan="3" align="center" valign="middle" bgcolor="#CCCCC"><p>INFORMATION PERSONNELLE</p>
        ...
        <tr>
          ...
          <td width="73%" bgcolor="#CCFFCC"><?php echo "<b>".$etudiant['matricule']."</b>"; ?><input name="matricule2" type="hidden" value="<?php echo $etudiant['matricule']; ?>" /></td>
        </tr>
        <tr>
          <td bgcolor="#CCFFCC" class="texte"><strong class="texte_grand">Nom :</strong></td>
          <td bgcolor="#CCFFCC"><label for="nom"></label>
        ...
        <tr>
          ...
          <td bgcolor="#CCFFCC"><label for="prenoms"></label>
        ...
        <tr>
          ...
          <td bgcolor="#CCFFCC"><label for="date_nais"></label>
        ...
        <tr>
          ...
          <td bgcolor="#CCFFCC" style="font-size:14px; color:#F00"><b><?php 
    ...
    <tr>
      ...
      <td colspan="3"><table width="100%" border="0" cellpadding="0" cellspacing="2" class="texte_grand">
        ...
        <?php
			for($i=0;$i<count($inscription);$i++){
				$a=0;
				if($inscription[$i]['annee_academique']==$anneeEtude){		
				$a++;
		?>
        <tr>
        ...
        <tr>
          <td colspan="2" align="center" bgcolor="#EAFAD1"><br />
            <?php 
				...
				echo $inscription[$i]['filiere']." (".$inscription[$i]['statut'].")<hr/>MONTANT : ".$montant; 
			?>
            </td>
          </tr>
        <tr>
